...
public class SpringCacheRegionFactory extends JCacheRegionFactory {
	...
	public static final ThreadLocal<org.springframework.cache.CacheManager> SPRING_CACHE_MANAGER = new InheritableThreadLocal<org.springframework.cache.CacheManager>();
