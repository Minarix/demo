...
public class DynamicDataSourceAspect {
	...
	@Before("@annotation(lxk.common.datasource.DynamicDataSourceAnnotation)") // 前置通知
	...
	@After("@annotation(lxk.common.datasource.DynamicDataSourceAnnotation)") // 后置通知
